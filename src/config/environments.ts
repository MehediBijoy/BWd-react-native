...
export const EU_API_URL = process.env.REACT_APP_EU_API_URL || 'https://api-dev.brettonwoods.gold'
export const US_API_URL = process.env.REACT_APP_US_API_URL || 'https://api-dev.brettonwoods.us.com'
