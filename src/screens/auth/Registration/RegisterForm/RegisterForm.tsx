...
const registerSchema = yup.object().shape({
  ...
  earnings: yup.string().nullable(),
  trading_experience: yup.string().nullable(),
})

const RegisterForm = () => {
  const styles = useStyles()
  const methods = useYupHooks({schema: registerSchema})
      ...
      <ScrollView>
        <Box gradient>
          ...
          <Form methods={methods} style={styles.form}>
            ...
            <Button title='Register Now' type='solid' color='secondary' />
          </Form>
        </Box>
      </ScrollView>
    </SafeAreaView>
